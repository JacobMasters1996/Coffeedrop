        ...
        <div class="container">
            <nav class="navbar navbar-expand-xl p-0">
                <a href="/" title="home" class="navbar-toggler alt-hidden">
                    <img src="<?php echo get_template_directory_uri(); ?>/inc/assets/images/coffee-drop-logo.png" onerror="this.onerror=null; this.src='<?php echo get_template_directory_uri(); ?>/inc/assets/images/coffee-drop-logo.png'">
                </a >
